...
bin_dir = prefix/'bin'
for name in ('project-setup', 'project-update', 'git-setup', 'project-lisence'):
    path = bin_dir/name
...
for name, module, function in [('project-setup','cli','setup_main'),('project-update','cli','update_main'),('git-setup','gitsetup','main'),('project-lisence','licensing','main')]:
    path = bin_dir/name
...
print(f'Installed project-setup, project-update, git-setup and project-lisence in {bin_dir}')
